...
const farmers: Farmer[] = [
  {
    ...
    image: "/assets/images/farmer-1.jpg"
  },
  {
    id: 2,
    name: "Juan P.",
    ...
    image: "/assets/images/farmer-2.jpg"
  },
  {
    id: 3,
    name: "Ana R.",
    ...
    image: "/assets/images/farmer-3.jpg"
  }
];
...
const maoStaff: MAOStaff[] = [
  {
    ...
    image: "/assets/images/mao-staff-1.jpg"
  },
  {
    id: 2,
    name: "Elena Suarez",
    position: "Program Coordinator",
    image: "/assets/images/mao-staff-2.jpg"
  },
  {
    id: 3,
    name: "Roberto Garcia",
    position: "Field Technician",
    image: "/assets/images/mao-staff-3.jpg"
  }
];
            ...
            {buyers.map((buyer, index) => (
              <div key={index} className="scroll-animate group bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border-2 border-gray-200 hover:border-emerald-400 overflow-hidden flex flex-col h-full hover:-translate-y-2" style={{ animationDelay: `${index * 0.1}s` }}>
                ...
                <div className="h-48 overflow-hidden">
                  <img 
                    src={`/assets/images/buyer-${index + 1}.jpg`} 
                    alt={buyer.name} 
